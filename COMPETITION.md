...
| O-02 | `team_id`, submitter name, email, GitHub handle | **CLOSED.** `metadata.json` filled: team_id `mhizha`, Simbarashe Timothy Motsi, simbamotsi1@gmail.com, GitHub handle `simbaTmotsi`. `test_placeholders_are_detectable_before_submission` passes outright rather than xfailing |
